 ...
 *
 * Disassembly of ssdt15.dat, Sun Oct 19 21:22:56 2025
 *
...
DefinitionBlock ("", "SSDT", 2, "INTEL ", "IgfxSsdt", 0x00003000)
{
    ...
    External (_SB_.PEPD.EMIM, IntObj)
    ...
    Scope (\_SB.PC00.GFX0)
    {
        ...
        {
            HPMO = ToInteger (Arg0)
            PADC = \_SB.GPC0 (0x08000003)
            If ((HPMO == Zero))
            {
                PADC &= 0xFFF7FFFF
                \_SB.SPC0 (0x08000003, PADC)
                \_SB.SPMV (0x08000003, One)
            }
            ElseIf ((\_SB.PEPD.EMIM == Zero))
            {
                \_SB.SPMV (0x08000003, Zero)
                \_SB.SHPO (0x08000003, Zero)
                \_SB.GRXE (0x08000003, One)
                PADC = \_SB.GPC0 (0x08000003)
                PADC |= 0x00080000
                PADC &= 0xFFFFFDFF
                \_SB.SPC0 (0x08000003, PADC)
